          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-sm text-white/60 max-w-xs">
                Discover the best movies and stay up to date with the latest cinematic releases.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4 max-w-xs">
                <div className="bg-white/5 rounded-lg p-3">
                  ...
                  <div className="text-xs text-white/60">Available Movies</div>
                </div>
                <div className="bg-white/5 rounded-lg p-3">
                  <div className="text-lg font-bold text-white/90">15+</div>
                  <div className="text-xs text-white/60">Different Genres</div>
                </div>
              </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/5">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-white/40">
              © 2024 MovieScope. All rights reserved.
            </p>
            <p className="text-sm text-white/40">
              Made by{" "}
              <a
